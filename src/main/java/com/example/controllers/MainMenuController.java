...
public class MainMenuController extends Controller implements Initializable {
    ...
    private void setupButtonIcons() {
        ...
        settingsBtn.setOnMouseEntered(e -> {
            iconRegion.setStyle("-fx-background-color: #f5ead9;");
            iconRegion.setScaleX(1.1);
            iconRegion.setScaleY(1.1);
        });
        
        settingsBtn.setOnMouseExited(e -> {
            iconRegion.setStyle("-fx-background-color: #d9c9a0;");
            iconRegion.setScaleX(1.0);
            iconRegion.setScaleY(1.0);
        });
        
        settingsBtn.setPrefSize(80, 80);
        settingsBtn.setMaxSize(80, 80);
        settingsBtn.setMinSize(80, 80);
