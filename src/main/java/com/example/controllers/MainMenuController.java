...
public class MainMenuController extends Controller implements Initializable {
    ...
    private void setupButtonAnimations() {
        // Apply to all buttons using the StyleManager
        StyleManager.setupButtonWithCustomCursor(newGameBtn);
        StyleManager.setupButtonWithCustomCursor(loadGameBtn);
        StyleManager.setupButtonWithCustomCursor(mapEditorBtn);
        StyleManager.setupButtonWithCustomCursor(settingsBtn);
        StyleManager.setupButtonWithCustomCursor(quitBtn);
    }
